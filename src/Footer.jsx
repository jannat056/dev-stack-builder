...
const Footer = () => {
  return (
    <footer className="w-full bg-[#0f172a] text-slate-300 border-t border-slate-800 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-5 gap-8">
        
        {/* Brand Section */}
        <div className="md:col-span-2 space-y-4">
          <div className="flex items-center gap-2">
            <span className="bg-gradient-to-r from-orange-500 to-pink-500 text-white font-bold p-2 rounded-lg text-lg shadow-md">DS</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 border-t border-slate-800/80 flex flex-col sm:flex-row justify-between items-center text-xs text-slate-500">
