    ...
    <nav className="sticky top-0 z-50 bg-white/85 backdrop-blur-md border-b border-gray-100 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden md:flex items-center space-x-10">
            <a 
              href="#home" 
              className="bg-gradient-to-r from-orange-500 to-pink-500 text-white font-semibold px-4 py-2 rounded-full shadow-md hover:opacity-90 transition-opacity"
            >
              Home
            </a>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-b border-gray-100 px-6 pt-4 pb-6 space-y-4 shadow-lg">
          <a 
            href="#home" 
            className="block bg-gradient-to-r from-orange-500 to-pink-500 text-white text-center font-medium py-2 rounded-full shadow-md"
          >
            Home
          </a>
